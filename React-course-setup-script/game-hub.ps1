...
$courseDir = "C:\Users\Avadhut\Desktop\Courses\code with mosh\8) React_with_TypeSC\1__React_18_for_Beginners\8_Project_Building_a_Video_Game_Discovery_App_3h_"
