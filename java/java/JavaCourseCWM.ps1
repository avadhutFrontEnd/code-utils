...
$courseDir = "C:\Users\Avadhut\Desktop\Courses\code with mosh\0) Java\Ultimate Java Part 1 Fundamentals"
...
# URLs to open
$urls = @(
    "https://chatgpt.com/c/689b1972-eaf0-8324-acc1-c9877cc9d05e",
...
$projectPath = "C:\Users\Avadhut\Desktop\git\8. Java Spring Boot\java"
