...
$projectPath = "C:\Users\Avadhut\Desktop\Notes\6. Node_JS - Notes\pics"
Start-Process "explorer.exe" -ArgumentList "`"$projectPath`""
$projectPath2 = "C:\Users\Avadhut\Desktop\Notes\6. Node_JS - Notes"
Start-Process "explorer.exe" -ArgumentList "`"$projectPath2`""
